...
arguments de compacité : consistent et stable
\subsubsection{Stabilisation}
TODO Tel quel : pas inversible, modes oscillants de pression. Ajout de
la stabilisation : expliquer comment. Méthode de clusters.
...
rectangles. Va poser des problèmes en stationnaire parce que
turbulent, essayer en instationnaire et voir si il y a solution
stationnaire dans la cheminée
\section{Conclusion}
TODO
\listoffigures
\listoftables
