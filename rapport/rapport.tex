...
increment $||x_{n} - x_{n-1}||_\infty$ and the residual $||f(x_n)||_\infty$ are lower than
$\varepsilon = 10^{-10}$. We numerically observe quadratic convergence
in about $12$ iterations, as can be seen Fig. \ref{fig:conv_newton}.
\begin{figure}[htb]
\centering
